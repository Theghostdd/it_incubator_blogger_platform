...
export const PostService = {
    ...
    async CreatePagination (page: number, pageSize: number): Promise<CreatePaginationType> {
        try {
            const getTotalCount: number = await PostQueryRepositories.GetCountElements()
