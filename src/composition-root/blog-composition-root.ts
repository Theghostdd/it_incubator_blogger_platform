...
import {postQueryRepositories, postRepositories} from "./post-composition-root";
...
export const blogController = new BlogController(blogQueryRepositories, blogService, new PostService(postRepositories, new BlogRepositories(BlogModel), PostModel, new UserRepositories(UserModel), CommentModel, new CommentRepositories(CommentModel, LikeModel)), postQueryRepositories)
